...
$GLOBALS['TCA']['tx_msrouten_domain_model_gebirge'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, gebirge',
	),
	'types' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_msrouten_domain_model_gebirge.pid=###CURRENT_PID### AND tx_msrouten_domain_model_gebirge.sys_language_uid IN (-1,0)',
			),
		),
