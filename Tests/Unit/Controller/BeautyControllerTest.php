...
/**
 * Test case for class Tx_Msrouten_Controller_BeautyController.
 *
 * @version $Id$
 ...
 */
class Tx_Msrouten_Controller_BeautyControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
