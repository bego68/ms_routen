...
/**
 * Test case for class Tx_Msrouten_Controller_MountsController.
 *
 * @version $Id$
 ...
 */
class Tx_Msrouten_Controller_MountsControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
