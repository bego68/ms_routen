...
/**
 * Test case for class Tx_Msrouten_Controller_RoutesController.
 *
 * @version $Id$
 ...
 */
class Tx_Msrouten_Controller_RoutesControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
